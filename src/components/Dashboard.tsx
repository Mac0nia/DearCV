        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center"> 
          <div className="group relative create-resume"> 
            <div className="relative bg-white/5 backdrop-blur-sm rounded-xl p-4 ring-1 ring-white/10 hover:ring-white/20 transition-all h-full flex flex-col">
              ...
              <button className="bg-primary hover:bg-primary-hover text-white w-full px-4 py-2 rounded-lg transition-colors duration-200">Create Resume</button>
            </div>
          </div>
          <div className="group relative upload-job-description"> 
            <div className="relative bg-white/5 backdrop-blur-sm rounded-xl p-4 ring-1 ring-white/10 hover:ring-white/20 transition-all h-full flex flex-col">
              ...
              <input type="url" placeholder="Enter Job URL" className="upload-url text-white p-2 rounded-lg mb-2 w-full" />
